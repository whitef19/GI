...
def argsparse():
	...
	parser.add_argument('-i', action='store', nargs='*', dest='data', metavar='file', help='xlsx files list to parse',required=True)
	...
	parser.add_argument('-b', action='store', dest='pickle', help='output binary file (default=islands.pickle)',default='islands.pickle')
